...
def build_fv(vader: dict, bert: dict, goe: dict, emoji: dict, context: dict = None) -> np.ndarray:
    ...
    # The DB currently doesn't store context engine vectors natively in the training set.
    # We pad with zeros to maintain 115-dimensional compatibility for retraining.
    for _ in range(48):
        vec.append(0.0)
